...
# This does not use the desiutil installation infrastructure so that rotcurve
...
#
# Does not support:
# - python setup.py version  (edit py/rotcurve/_version.py instead)

import os, glob, re
from setuptools import setup, find_packages

def _get_version():
    line = open('py/rotcurve/_version.py').readline().strip()
...
setup_keywords = dict(
    ...
    description='Rotation curve fitting',
    author='UR Cosmology Group',
    author_email='sbenzvi@ur.rochester.edu',
    license='BSD',
    url='https://github.com/DESI-UR/rotcurve',
)
...
#- Testing
setup_keywords['test_suite'] = 'rotcurve.test.test_suite'
